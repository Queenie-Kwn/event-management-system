...
<head>
    ...
    <title>Request Business Certification - Barangay Bagacay</title>
    ...
    <header class="bg-white/80 backdrop-blur-sm border-b border-white/20 shadow-sm p-6 mb-8">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-xl font-semibold text-gray-900">Request Business Certification</h1>
    ...
    <div class="flex gap-6 p-6">
        ...
        <div class="w-1/3 bg-white rounded-2xl shadow-lg p-6">
            ...
            <form action="{{ route('user.request.document') }}" method="POST" class="space-y-4">
                @csrf
                <input type="hidden" name="document_type" value="Business Certification">
                ...
                <div>
                    ...
                    <input type="text" id="businessType" name="business_type" class="w-full bg-slate-50 border-0 rounded-xl px-4 py-3 text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20" placeholder="Sari-sari store, Restaurant, etc." required>
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-2">Business Since (Year)</label>
                    <input type="number" id="businessYear" name="business_year" class="w-full bg-slate-50 border-0 rounded-xl px-4 py-3 text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20" placeholder="Year started" min="1990" max="2030" required>
                </div>
                ...
                <div class="bond-paper bg-white border-2 border-slate-200 p-12 mx-auto relative" style="width: 600px; min-height: 800px; transform: scale(0.8); transform-origin: top;">
                    ...
                    <div class="text-sm leading-relaxed space-y-4">
                        ...
                        <p>
                            ...
                            Barangay Bagacay, Dumaguete City, is engaged in <span id="previewBusiness" class="underline">_________________</span>
